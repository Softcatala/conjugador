...
def _set_plurals_singulars(tense, lemma_subdict):
    ...
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "1S0"
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "2S0"
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "3S0"
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "1P0"
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "2P0"
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "3P0"
    )
...
def _set_plurals_singulars_participi(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM"
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SF"
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0PM"
    )
    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0PF"
    )
...
def _set_infinitiu_compost(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haver "
    )
...
def _set_gerundi_compost(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havent "
    )
...
def _set_perfet_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "he "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "has "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "ha "
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hem "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "heu "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "han "
    )
...
def _set_plusquamperfet_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havia "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havies "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havia "
    )
    ...
    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havíem "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havíeu "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "havien "
    )
...
def _set_passatperifrastic_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "N":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "vaig "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "vas (vares) "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "va "
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "vam (vàrem) "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "vau (vàreu) "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "000", "van (varen) "
    )
...
def _set_passatanterior_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguí "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagueres "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagué "
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguérem "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguéreu "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagueren "
    )
...
def _set_passatanteriorperifrastic_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "vaig haver "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "vas haver "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "va haver "
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "vam haver "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "vau haver "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "van haver "
    )
...
def _set_futurperfet_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauré "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauràs "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haurà "
    )

    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haurem "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haureu "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauran "
    )
...
def _set_condicionalperfet_indicatiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauria (haguera) "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauries (hagueres) "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauria (haguera) "
    )
    ...
    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauríem (haguérem) "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hauríeu (haguéreu) "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haurien (hagueren) "
    )
...
def _set_perfet_subjuntiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagi (haja) "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagis (hages) "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagi (haja) "
    )
    ...
    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hàgim (hàgem) "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hàgiu (hàgeu) "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagin (hagen) "
    )
...
def _set_plusquamperfet_subjuntiu(tense, lemma_subdict):
    if _get_verb_mode(tense.postag) != "P":
        return
    tense.singular1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagués (haguera) "
    )
    tense.singular2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguessis (hagueres) "
    )
    tense.singular3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "hagués (haguera) "
    )
    ...
    tense.plural1 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguéssim (haguérem) "
    )
    tense.plural2 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguéssiu (haguéreu) "
    )
    tense.plural3 = _get_forms_with_variant(
        lemma_subdict, tense.postag + "0SM", "haguessin (hagueren) "
    )
...
def _get_tenses(input_dict, lemma):
    ...
    for verb_type in verb_types:
        ...
        tenses.append(
            Tense("Indicatiu", "Plusquamperfet", "V" + verb_type + "P0")
        )
        _set_plusquamperfet_indicatiu(tenses[-1], lemma_subdict)
        tenses.append(
            Tense("Indicatiu", "Passat simple", "V" + verb_type + "IS")
        )
        tenses.append(
            Tense("Indicatiu", "Passat perifràstic", "V" + verb_type + "N0")
        )
        _set_passatperifrastic_indicatiu(tenses[-1], lemma_subdict)
        tenses.append(
            Tense("Indicatiu", "Passat anterior", "V" + verb_type + "P0")
        )
        ...
        tenses.append(
            Tense("Indicatiu", "Futur perfet", "V" + verb_type + "P0")
        )
        _set_futurperfet_indicatiu(tenses[-1], lemma_subdict)
        tenses.append(
            Tense("Indicatiu", "Condicional", "V" + verb_type + "IC")
        )
        tenses.append(
            Tense("Indicatiu", "Condicional perfet", "V" + verb_type + "P0")
        )
        ...
        tenses.append(
            Tense("Subjuntiu", "Plusquamperfet", "V" + verb_type + "P0")
        )
        ...
        tenses.append(
            Tense("Formes no personals", "Infinitiu", "V" + verb_type + "N0")
        )
        ...
        tenses.append(
            Tense("Formes no personals", "Gerundi", "V" + verb_type + "G0")
        )
        ...
        tenses.append(
            Tense("Formes no personals", "Participi", "V" + verb_type + "P0")
        )
        _set_plurals_singulars_participi(
            tenses[len(tenses) - 1], lemma_subdict
        )
...
def rename_anar_aux_infinitive(lemma, tenses):
    if lemma == "anar_aux":
        ...
        for i in range(len(tenses)):
            ...
            if any(
                ext in tense.tense
                for ext in ("Passat perifràstic", "Infinitiu")
            ):
...
def _set_definition(lemma, tenses, definitions):
    ...
    if lemma in definitions:
        ...
        definition["definition_credits"] = (
            "La definició del verb prové del Viccionari i està sotmesa "
            ...
            f"Podeu millorar-la editant <a href='https://ca.wiktionary.org/wiki/{lemma}'>l'entrada al Viccionari</a>."
        )
    else:
        definition["definition_credits"] = (
            "Aquest verb no és al Viccionari, que és la font que usem per a les definicions. "
            f"Podeu afegir la definició creant <a href='https://ca.wiktionary.org/wiki/{lemma}'>l'entrada al Viccionari</a>."
        )
...
def main():
    ...
    exclusions_file = (
        "catalan-dict-tools/fdic-to-hunspell/dades/exclusions-conjugador.txt"
    )
